...
public class Database {
    ...
    public Database(String type, String url, String username, String password) throws Exception {
        this.type = type;
        this.url = "jdbc:" + url;
        ...
        if(!DbUtils.loadDriver(driver))
            throw new Exception("Please make sure the " + type + " driver library jar exists.");
    }
    ...
    public Mini getDatabase() {
        ...
        return new Mini("plugins/iConomy", "accounts.mini");
    }
    ...
    public Mini getTransactionDatabase() {
        ...
        return new Mini("plugins/iConomy", "transactions.mini");
    }
